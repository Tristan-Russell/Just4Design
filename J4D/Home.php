...
<body onload="hideElements()" style="background-color: #ffffff;background-image: url(&quot;assets/img/2312673.jpg&quot;);">
    ...
    <div id="register" class="register-photo" style="background-color: rgba(241,247,252,0);">
        <div class="form-container">
            <form action ="register.php" method="POST" style="background-color: #dddddd;">
                ...
                <div class="form-group">
                    <div class="form-check"><label class="form-check-label"><input name="LA" class="form-check-input" type="checkbox">I agree to the license terms.</label></div>
                </div>
                ...
                </div><a class="already" href="#">You already have an account? Login here.</a>
            </form>
        </div>
    </div>
    ...
    <div id="products" class="row" style="margin-top: 100px;height: 500px;margin-right: 10px;margin-left: 100px;">
        <div class="col-xl-4 offset-xl-0" style="height: 198px;width: 355px;">
            ...
            <img name="wShirts" class="border rounded-0 border-dark" src="assets/img/Mott%20&%20Bow%20Fitted%20Crew.jpg" style="height: 150px;margin-left: 10px;" onclick="imageClick(this.name)">
        </div>
        ...
        <div class="col-xl-4" style="height: 198px;">
            ...
            <img name="Mugs"class="border rounded-0 border-dark" src="assets/img/istockphoto-821282266-612x612.jpg" style="height: 150px;" onclick="imageClick(this.name)">
        </div>
        <div class="col-xl-4">
            <h2 style="font-family: Aclonica, sans-serif;">Buffs</h2>
            <img name="Buffs"class="border rounded-0 border-dark" src="assets/img/light-grey-buff.jpg" style="height: 150px;" onclick="imageClick(this.name)">
        </div>
        <div class="col-xl-4">
        ...
        <div class="col-xl-4">
            ...
            <img name="Keychains"class="border rounded-0 border-dark" src="assets/img/KCR113__81858.1607361344.jpg" style="height: 150px;" onclick="imageClick(this.name)">
        </div>
    </div>

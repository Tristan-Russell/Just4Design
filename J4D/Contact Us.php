...
echo '<script src="Script.js">> </script>';
    if (isset($_POST['send'])) {
        ...
        $to = "tristanrussell2142@gmail.com";
        $subject = "Contact Us";
        ...
        if ($result)
        {
        echo "<script type='text/javascript'>alert('Message Recieved'); window.location.href = 'Contact Us.html';</script>";
        }
        else
        {
        echo "<script type='text/javascript'>alert('ERROR!'); window.location.href = 'Contact Us.html';</script>";
        }
    }
    ?>
<!DOCTYPE html>
...
<form method="POST" >
    ...
    <script src="D:\XAMPP\htdocs\ITEC Dev2\Script.js"></script>

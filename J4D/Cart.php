...
if (isset($_POST['btnCheckout'])) {
   ...
   $allDetail =$_SESSION['allDetails'];
        $sql4 = "INSERT INTO cart (cEmail, cID, prodName, prodDetails ,ordTotal)
          VALUES ('$username','$userID','$allProduct','$allDetail','$Total')";
...
<form method="POST" >
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="margin-right: 20px;margin-left: 250px;margin-top: -125px;background-color: rgba(255,255,255,0.49);height: 49px;width: 910px;">
        <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" style="margin-right: 0px;"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1" style="width: 764px;margin-right: 10px;">
                ...
                <a href="http://localhost/ITEC%20Dev2/Cart.php" target="_self"> <button name="btnCart" method= "POST" type="submit" style="margin-right: 22px;margin-top: -0;margin-left: -75px;">Cart</button></a> 
                ...
                <div class="dropdown"><a class="dropdown-toggle border rounded-0" data-toggle="dropdown" aria-expanded="false" href="#" style="padding: 7px;padding-top: 0px;padding-right: 9px;color: #ffffff;padding-left: -25px;background-color: #585858;margin-left:
                    ...
                    <div class="dropdown-menu" role="menu" style="margin-left: -83px;">
                        ...
                        <a class="dropdown-item" role="presentation" href="http://localhost/ITEC%20Dev2/Contact Us.html">Contact
                            Us</a>
                        <a class="dropdown-item" role="presentation" href="http://localhost/ITEC%20Dev2/About Us.html">About
                            Us</a>
                    </div>
    ...
    <div class="contact-clean" style="background-color: rgba(241,247,252,0);height: 649px;">
        <h2 class="text-left" style="margin-left: 40px;">Your Cart</h2>
        ...
        <form method ="POST"style="margin-top: -490px;margin-left: 450px;width: 350px;background-color: rgba(255,255,255,0.4);padding-top: 18px;">
            <h5>Contact Details</h5><input class="form-control" type="text" style="margin-bottom: 10px;" value="<?php echo $username; ?>" inputmode="email"><input class="form-control" type="text" style="margin-bottom: 10px;" placeholder="Contact No">
            <h5>Billing Address</h5><input class="form-control" type="text" style="margin-bottom: 10px;" value="<?php echo $AddressLine1; ?>"><input class="form-control" type="text" style="margin-bottom: 10px;" value="<?php echo $AddressLine2; ?>">
            <input class="form-control" type="text" style="margin-bottom: 10px;" value="<?php echo $Province; ?>"><input class="form-control" type="text" value="<?php echo $Postal; ?>" style="width: 150px;margin-bottom: 15px;">
    ...
    <div class="footer-basic" style="height: 120px;">
        <footer>
            <ul class="list-inline">
                ...
                <li class=" list-inline-item"><a href="http://localhost/ITEC%20Dev2/Contact Us.html">Contact</a>
                </li>
                <li class="list-inline-item"><a href="http://localhost/ITEC%20Dev2/About Us.html">About</a>
                </li>
            </ul>

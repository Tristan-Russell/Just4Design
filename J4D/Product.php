<?php 
 ...
 switch ($prodName){
     case "mShirts" : 
      ...
      case "wShirts" : 
         $imgSrc=  'assets/img/Mott%20&%20Bow%20Fitted%20Crew.jpg';
      break;
      ...
      case "Buffs" : 
         $imgSrc= 'assets/img/light-grey-buff.jpg"';
      break;
      ...
      case "Keychains" : 
         $imgSrc=  'assets/img/KCR113__81858.1607361344.jpg';
      break;
 
      case "Mugs" : 
         $imgSrc= 'assets/img/istockphoto-821282266-612x612.jpg';
      break;
...
<body   style="background-color: #ffffff;background-image: url(&quot;assets/img/2312673.jpg&quot;);"><img src="assets/img/Picture12.png" style="height: 152px;margin-left: 15px;margin-top: 10px;" onclick="window.location.href='http://localhost/ITEC%20Dev2/Index.php'"> 
...
<form method="POST" >
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button" style="margin-right: 20px;margin-left: 250px;margin-top: -125px;background-color: rgba(255,255,255,0.49);height: 49px;width: 910px;">
        ...
        <div class="contact-clean" style="background-color: rgba(241,247,252,0);height: 800px;">
        ...
        <strong><p style="width: 600px;margin-top: -160px;margin-left: 420px;height: 150px;"><?php echo  $Description; ?><br/>
         Price: R<?php echo  $prodValue; ?></p></strong>
